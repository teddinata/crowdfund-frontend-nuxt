...
<body class="antialiased ">
   <div class="container mx-auto relative">
    <div class="landing-page">
          ...
          <div class="flex items-center pt-10 px-5 md:px-0">
            <div class="w-1/2">
              <h1 class="text-4xl text-white mb-5">
                We helpssss <u class="hero-underline">startup</u> to <br />
      ...
      <section class="container mx-auto pt-24 px-6">
      ...
      <section class="container mx-auto pt-24 px-6">
        ...
        <div class="grid grid-cols-3 gap-4 mt-3">
          <!-- if campaign > 0 then show data, else campaign = 0 then show have no data -->
          <div v-if="campaigns.data.length == 0" class="w-full">
            <!-- position center -->
          ...
          <div v-for="campaign in campaigns.data" :key="campaign.id"
            class="card-project w-full mx-6 my-4 p-5 border border-gray-500 rounded-20"
          >
            <div class="item">
              ...
              <div class="item-meta">
                ...
                <div class="flex progress-info">
                  ...
                  <div class="ml-auto font-semibold">Rp {{ Intl.NumberFormat('id-ID').format(campaign.goal_amount)}}</div>
                </div>
              </div>
              <button
