          ...
          >
            <div class="mb-8">
              ...
              <p class="text-sm text-gray-600 flex items-center mb-2">
               Target Investasi: Rp {{ Intl.NumberFormat('id-ID').format(campaign.goal_amount) }}
              </p>
              <p class="text-sm font-bold text-gray-600 flex items-center mb-2">
                Total Investasi: Rp {{ Intl.NumberFormat('id-ID').format(campaign.current_amount) }} &middot; {{ (campaign.current_amount / campaign.goal_amount) *100 }}%
               </p>
